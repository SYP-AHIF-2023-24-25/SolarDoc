 ...
 */
export function postV1FilePermission(
 ...
 */
export function getV1FilePermissionById(
  authorization: string,
  id: string,
  opts?: Oazapfts.RequestOpts,
) {
 ...
 */
export function putV1FilePermissionById(
  authorization: string,
  id: string,
  updatePermission: UpdateFilePermissions,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.fetchJson<
    | {
 ...
 */
export function getV1FileByFileIdPermission(
  authorization: string,
  fileId: string,
  opts?: Oazapfts.RequestOpts,
) {
 ...
 */
export function getV1FileByFileIdPermissionAndUserId(
  authorization: string,
  fileId: string,
  userId: string,
  opts?: Oazapfts.RequestOpts,
