...
export function postV1RenderPresentationImages(renderPresentationDtoModel?: RenderPresentationDtoModel, opts?: Oazapfts.RequestOpts) {
    ...
    }>("/v1/render/presentation/images", oazapfts.json({
        ...opts,
        method: "POST",
...
export function postV1RenderPresentationPdf(renderPresentationDtoModel?: RenderPresentationDtoModel, opts?: Oazapfts.RequestOpts) {
    ...
    }>("/v1/render/presentation/pdf", oazapfts.json({
        ...opts,
        method: "POST",
        body: renderPresentationDtoModel
    }));
...
export function postV1RenderSlideByUuidImage(uuid: string, renderPresentationDtoModel?: RenderPresentationDtoModel, opts?: Oazapfts.RequestOpts) {
    ...
    }>(`/v1/render/slide/${encodeURIComponent(uuid)}/image`, oazapfts.json({
        ...opts,
        method: "POST",
        body: renderPresentationDtoModel
    }));
...
export function getV1ResultByUuid(uuid: string, { $static }: {
    ...
    return oazapfts.fetchBlob<{
        ...
        status: 404;
    }>(`/v1/result/${encodeURIComponent(uuid)}${QS.query(QS.explode({
        "static": $static
    }))}`, {
        ...opts
    });
