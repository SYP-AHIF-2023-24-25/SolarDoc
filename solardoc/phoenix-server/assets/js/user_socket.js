...
let socket;
if (!window.userToken) {
    console.log("[SDS] 'window.userToken' is undefined or empty, user is probably logged out. Will not connect to socket.")
} else {
    // And connect to the path in "lib/solardoc_phoenix_web/endpoint.ex". We pass the
    // token for authentication. Read below how it should be used.
    socket = new Socket("/sds", {params: {token: window.userToken}})
