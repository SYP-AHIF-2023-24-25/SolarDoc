defmodule SolardocPhoenixWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_solardoc_phoenix_web_user_remember_me"
  ...
  the current_user:
      ...
      defmodule SolardocPhoenixWeb.PageLive do
        use SolardocPhoenixWeb, :live_view

        on_mount {SolardocPhoenixWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{SolardocPhoenixWeb.UserAuth, :ensure_authenticated}] do
