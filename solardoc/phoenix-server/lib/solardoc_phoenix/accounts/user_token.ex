defmodule SolardocPhoenix.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias SolardocPhoenix.Accounts.UserToken
  ...
  defp days_for_context("api-token"), do: @api_token_validity
